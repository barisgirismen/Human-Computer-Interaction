...
public class Shopping1 {
    ...
    public Shopping1() {
        ...
        JTextField allItemsTotal = new JTextField(""+selectedCupHolder.getCost() * ((Integer) selectAmount.getValue())); //Grand Total
               ...
               int amount = (Integer) selectAmount.getValue();
                switch (selection) {
                    case 0:
                        ...
                        allItemsTotal.setText(""+ selectedCupHolder.getCost() * amount);
                        break;
                    case 1:
                        totalCost.setText(""+ selectedDashcam.getCost() * amount);
                        allItemsTotal.setText(""+ selectedDashcam.getCost() * amount);
                        break;
                    case 2:
                        totalCost.setText(""+ selectedDice.getCost() * amount);
                        allItemsTotal.setText(""+ selectedDice.getCost() * amount);
                        break;
                    case 3:
                        totalCost.setText(""+ selectedFakeTurbo.getCost() * amount);
                        allItemsTotal.setText(""+ selectedFakeTurbo.getCost() * amount);
                        break;
                    case 4:
                        totalCost.setText(""+ selectedHeadUpDisplay.getCost() * amount);
                        allItemsTotal.setText(""+ selectedHeadUpDisplay.getCost() * amount);
                        break;
                    case 5:
                        totalCost.setText(""+ selectedOrnament.getCost() * amount);
                        allItemsTotal.setText(""+ selectedOrnament.getCost() * amount);
                        break;
                    case 6:
                        totalCost.setText(""+ selectedPhoneHolder.getCost() * amount);
                        allItemsTotal.setText(""+ selectedPhoneHolder.getCost() * amount);
                        break;
                    case 7:
                        totalCost.setText(""+ selectedSunshade.getCost() * amount);
                        allItemsTotal.setText(""+ selectedSunshade.getCost() * amount);
                        break;
                    case 8:
                        totalCost.setText(""+ selectedUSBCharger.getCost() * amount);
                        allItemsTotal.setText(""+ selectedUSBCharger.getCost() * amount);
                        break;
                    default:
                        System.err.println("Error.");
                        break;
        ...
        switch (selection) {
                case 0:
                    ...
                    netTotal += shoppingCart.get(0).getTotalCost();
                    break;
                case 1:
